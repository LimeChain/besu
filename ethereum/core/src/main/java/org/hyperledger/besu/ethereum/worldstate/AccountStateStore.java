...
public interface AccountStateStore {
	...
	/**
	 * Removes a given address from state. Must clear the contract code and storage of the account as-well!
	...
	/**
	 * Commits the performed changes into the State. All operations must be provisional and applied on commit
	 */
	void commit();
}
